...
func Pastebin(ctx *gin.Context) {
	dialog := xbmc.NewDialogProgressBG("dainc", "LOCALIZE[30457]", "LOCALIZE[30457]")
	if dialog != nil {
		dialog.Update(0, "dainc", "LOCALIZE[30457]")
	}
	pasteURL := ""
	defer func() {
		if dialog != nil {
		...
		if pasteURL != "" {
			xbmc.Dialog("dainc", "LOCALIZE[30454];;"+pasteURL)
		}
	}()
